...
export function MessageBubble({ msg, isFull }: { msg: ChatMessage, isFull?: boolean }) {
  return (
    msg.content.trim() === "" && msg.attachments.length === 0 ? (
      ...
      <div className={`flex gap-3 max-w-[82%] ${msg.role === "user" ? "flex-row-reverse" : ""}`}>
        ...
        <div 
          ...
          style={
            msg.role === "user"
              ? { background: "var(--base-dark-teal)", color: "var(--base-teal)" }
              : undefined
          }
        >
